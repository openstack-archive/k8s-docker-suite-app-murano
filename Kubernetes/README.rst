...
To use Rolling updates via Deployments consult Kubernetes documentation `here`_.
In case users still have resources using RC and requires update please 
consult Kubernetes documentation `here`_.

Since all apps which installed from Murano Catalog deployed as Deployments, users can
take advantage of using rolling updates via Deployment abstraction.


.. Links

.. _here: http://kubernetes.io/docs/user-guide/rolling-updates/
.. _here: http://kubernetes.io/docs/user-guide/deployments/#updating-a-deployment
