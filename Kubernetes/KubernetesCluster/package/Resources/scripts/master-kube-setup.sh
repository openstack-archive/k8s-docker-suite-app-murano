...
#sed -i.bak "s/%%MASTER_IP%%/$2/g" /opt/copy/calico-etcd.manifest
#cp -f /opt/copy/calico-etcd.manifest /etc/kubernetes/manifests
...
calicoctl pool add 10.0.200.0/24 --nat-outgoing
